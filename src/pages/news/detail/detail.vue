...
<template>
    <div class="container">
        <div v-if="detail.is_vedio" class="news-video">
            ...
            <div class="videoDetail">
                ...
                <!--<video :poster="detail.pics[0].url" :src="detail.videos[0].url" class="h5video" controls></video>-->
            </div>
            <div class="videoDescripton">
                {{detail.text}}
            </div>
        </div>
        <div v-else class="news-articl">
            <div class="downloadApp" v-if="outOfApp">
                <div class="ofo">
                    <label class="icon"></label>
                </div>
            ...
            <div class="news" v-bind:class="{ 'news--out': outOfApp }" v-if="detail.id">
                ...
                <div class="news-content" v-html="detail.text.replace(/\n/ig, '<br />')">{{}}</div>
            ...
            if(id){
                API.newsDetail({
                    ...
                    if(data.errors){
                        ...
                        if (this.detail.is_vedio) {
                            this.playerOptions.sources = [{
                                type: "video/mp4",
                                src:  this.detail.videos[0].url,
                            }]
                        }
